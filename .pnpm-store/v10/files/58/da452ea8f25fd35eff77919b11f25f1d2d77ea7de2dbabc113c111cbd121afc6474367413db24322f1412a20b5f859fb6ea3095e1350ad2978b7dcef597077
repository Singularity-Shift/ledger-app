...
exports.GenesisState = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.nextL2Sequence !== 0n) {
            ...
            writer.uint32(32).uint64(message.nextL2Sequence.toString());
        }
        if (message.nextL1Sequence !== 0n) {
            ...
            writer.uint32(40).uint64(message.nextL1Sequence.toString());
        }
        if (message.bridgeInfo !== undefined) {
            types_1.BridgeInfo.encode(message.bridgeInfo, writer.uint32(50).fork()).ldelim();
        }
        if (message.exported !== false) {
            writer.uint32(56).bool(message.exported);
        }
        for (const v of message.denomPairs) {
            types_1.DenomPair.encode(v, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            denomPairs: gt.Array.isArray(object?.denomPairs)
                ? object.denomPairs.map((e) => types_1.DenomPair.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
