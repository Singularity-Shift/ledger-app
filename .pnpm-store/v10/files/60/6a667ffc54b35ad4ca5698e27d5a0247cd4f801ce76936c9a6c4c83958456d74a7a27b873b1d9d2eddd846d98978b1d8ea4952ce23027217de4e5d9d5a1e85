...
exports.Validator = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.unbondingOnHoldRefCount !== 0n) {
            ...
            writer.uint32(104).int64(message.unbondingOnHoldRefCount.toString());
        }
        if (message.unbondingId !== 0n) {
            ...
            writer.uint32(112).uint64(message.unbondingId.toString());
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 8:
                    ...
                    message.unbondingHeight = longToBigint(reader.int64());
                    continue;
                case 9:
                    if (tag !== 74) {
                        break;
                ...
                case 13:
                    ...
                    message.unbondingOnHoldRefCount = longToBigint(reader.int64());
                    continue;
                case 14:
                    if (tag !== 112) {
                        break;
                    }
                    message.unbondingId = longToBigint(reader.uint64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            votingPowers: gt.Array.isArray(object?.votingPowers)
...
exports.DVVTriplets = {
    ...
    fromJSON(object) {
        return {
            triplets: gt.Array.isArray(object?.triplets)
    ...
    fromJSON(object) {
        return {
            ...
            initialBalance: gt.Array.isArray(object?.initialBalance)
                ? object.initialBalance.map((e) => coin_1.Coin.fromJSON(e))
                : [],
            sharesDst: gt.Array.isArray(object?.sharesDst)
...
exports.Params = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.minVotingPower !== 0n) {
            ...
            writer.uint32(48).uint64(message.minVotingPower.toString());
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    message.minVotingPower = longToBigint(reader.uint64());
                    continue;
                case 7:
                    if (tag !== 58) {
                        break;
    ...
    fromJSON(object) {
        return {
            notBondedTokens: gt.Array.isArray(object?.notBondedTokens)
                ...
                : [],
            bondedTokens: gt.Array.isArray(object?.bondedTokens)
