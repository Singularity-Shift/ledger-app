...
exports.GrpcWebError = exports.GrpcWebImpl = exports.MsgSetSendEnabledDesc = exports.MsgUpdateParamsDesc = exports.MsgMultiSendDesc = exports.MsgSendDesc = exports.MsgDesc = exports.MsgClientImpl = exports.MsgSetSendEnabledResponse = exports.MsgSetSendEnabled = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgMultiSendResponse = exports.MsgMultiSend = exports.MsgSendResponse = exports.MsgSend = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.MsgMultiSend = {
    ...
    fromJSON(object) {
        return {
            inputs: gt.Array.isArray(object?.inputs) ? object.inputs.map((e) => bank_1.Input.fromJSON(e)) : [],
            outputs: gt.Array.isArray(object?.outputs) ? object.outputs.map((e) => bank_1.Output.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            ...
            sendEnabled: gt.Array.isArray(object?.sendEnabled)
                ...
                : [],
            useDefaultFor: gt.Array.isArray(object?.useDefaultFor)
                ? object.useDefaultFor.map((e) => gt.String(e))
                : [],
        };
    },
    toJSON(message) {
