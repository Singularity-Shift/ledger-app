...
exports.QueryAccountsResponse = {
    ...
    fromJSON(object) {
        return {
            accounts: gt.Array.isArray(object?.accounts) ? object.accounts.map((e) => any_1.Any.fromJSON(e)) : [],
...
exports.Bech32PrefixResponse = {
    ...
    fromJSON(object) {
        return { bech32Prefix: isSet(object.bech32Prefix) ? gt.String(object.bech32Prefix) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.bech32Prefix !== "") {
...
exports.AddressBytesToStringRequest = {
    ...
    fromJSON(object) {
        return {
            addressBytes: isSet(object.addressBytes) ? bytesFromBase64(object.addressBytes) : new Uint8Array(0),
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.AddressBytesToStringResponse = {
    ...
    fromJSON(object) {
        return { addressString: isSet(object.addressString) ? gt.String(object.addressString) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.addressString !== "") {
...
exports.QueryAccountAddressByIDRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.id !== 0n) {
            if (BigInt.asIntN(64, message.id) !== message.id) {
                throw new gt.Error("value provided for field message.id of type int64 too large");
            }
            writer.uint32(8).int64(message.id.toString());
        }
        if (message.accountId !== 0n) {
            if (BigInt.asUintN(64, message.accountId) !== message.accountId) {
                throw new gt.Error("value provided for field message.accountId of type uint64 too large");
            }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.id = longToBigint(reader.int64());
                    continue;
                case 2:
                    if (tag !== 16) {
                        break;
                    }
                    message.accountId = longToBigint(reader.uint64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            accountId: isSet(object.accountId) ? BigInt(object.accountId) : 0n,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.QueryAccountAddressByIDResponse = {
    ...
    fromJSON(object) {
        return { accountAddress: isSet(object.accountAddress) ? gt.String(object.accountAddress) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.accountAddress !== "") {
