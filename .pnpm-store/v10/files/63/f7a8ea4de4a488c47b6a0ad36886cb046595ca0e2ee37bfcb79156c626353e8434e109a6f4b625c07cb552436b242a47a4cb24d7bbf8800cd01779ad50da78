...
exports.MsgPublish = {
    ...
    fromJSON(object) {
        return {
            ...
            codeBytes: gt.Array.isArray(object?.codeBytes)
...
exports.MsgWhitelist = {
    ...
    create(base) {
        return exports.MsgWhitelist.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMsgWhitelist();
        message.authority = object.authority ?? "";
...
exports.MsgWhitelistResponse = {
    ...
    create(base) {
        return exports.MsgWhitelistResponse.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseMsgWhitelistResponse();
        return message;
...
exports.MsgDelist = {
    ...
    create(base) {
        return exports.MsgDelist.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMsgDelist();
        message.authority = object.authority ?? "";
...
exports.MsgDelistResponse = {
    ...
    create(base) {
        return exports.MsgDelistResponse.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseMsgDelistResponse();
        return message;
