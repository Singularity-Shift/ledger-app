...
exports.Params = {
    ...
    fromJSON(object) {
        return {
            ...
            baseProposerReward: isSet(object.baseProposerReward) ? gt.String(object.baseProposerReward) : "",
            bonusProposerReward: isSet(object.bonusProposerReward) ? gt.String(object.bonusProposerReward) : "",
...
exports.ValidatorHistoricalRewards = {
    ...
    fromJSON(object) {
        return {
            cumulativeRewardRatio: gt.Array.isArray(object?.cumulativeRewardRatio)
...
exports.ValidatorCurrentRewards = {
    ...
    fromJSON(object) {
        return {
            rewards: gt.Array.isArray(object?.rewards) ? object.rewards.map((e) => coin_1.DecCoin.fromJSON(e)) : [],
...
exports.ValidatorAccumulatedCommission = {
    ...
    fromJSON(object) {
        return {
            commission: gt.Array.isArray(object?.commission)
...
exports.ValidatorSlashEvent = {
    ...
    fromJSON(object) {
        return {
            ...
            fraction: isSet(object.fraction) ? gt.String(object.fraction) : "",
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.FeePool = {
    ...
    fromJSON(object) {
        return {
            communityPool: gt.Array.isArray(object?.communityPool)
...
exports.DelegatorStartingInfo = {
    ...
    fromJSON(object) {
        return {
            ...
            stake: isSet(object.stake) ? gt.String(object.stake) : "",
...
exports.DelegationDelegatorReward = {
    ...
    fromJSON(object) {
        return {
            ...
            reward: gt.Array.isArray(object?.reward) ? object.reward.map((e) => coin_1.DecCoin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.CommunityPoolSpendProposalWithDeposit = {
    ...
    fromJSON(object) {
        return {
            ...
            deposit: isSet(object.deposit) ? gt.String(object.deposit) : "",
        };
    },
    toJSON(message) {
        const obj = {};
