...
exports.HistoricalInfo = {
    ...
    fromPartial(object) {
        const message = createBaseHistoricalInfo();
        message.header =
            object.header !== undefined && object.header !== null ? types_2.Header.fromPartial(object.header) : undefined;
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 13:
                    if (tag === 104) {
                        message.unbondingIds.push(longToBigint(reader.uint64()));
                        continue;
                    }
                    if (tag === 106) {
    ...
    fromJSON(object) {
        return {
            ...
            unbondingOnHoldRefCount: isSet(object.unbondingOnHoldRefCount)
                ...
                : 0n,
            unbondingIds: gt.Array.isArray(object?.unbondingIds)
                ? object.unbondingIds.map((e) => BigInt(e))
                : [],
        };
    },
    toJSON(message) {
