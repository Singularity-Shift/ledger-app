...
exports.Proof = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.total !== 0n) {
            if (BigInt.asIntN(64, message.total) !== message.total) {
                throw new gt.Error("value provided for field message.total of type int64 too large");
            }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.total = longToBigint(reader.int64());
                    continue;
                case 2:
                    if (tag !== 16) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            aunts: gt.Array.isArray(object?.aunts) ? object.aunts.map((e) => bytesFromBase64(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
