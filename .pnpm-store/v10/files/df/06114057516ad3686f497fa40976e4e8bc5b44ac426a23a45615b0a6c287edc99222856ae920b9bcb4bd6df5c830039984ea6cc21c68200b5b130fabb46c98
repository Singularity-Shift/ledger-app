    ...
    fromJSON(object) {
        return {
            ...
            finalizeBlock: isSet(object.finalizeBlock)
                ? exports.RequestFinalizeBlock.fromJSON(object.finalizeBlock)
                : undefined,
        };
    },
    toJSON(message) {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.blockVersion !== 0n) {
            if (BigInt.asUintN(64, message.blockVersion) !== message.blockVersion) {
                throw new gt.Error("value provided for field message.blockVersion of type uint64 too large");
            }
        ...
        if (message.p2pVersion !== 0n) {
            if (BigInt.asUintN(64, message.p2pVersion) !== message.p2pVersion) {
                throw new gt.Error("value provided for field message.p2pVersion of type uint64 too large");
            }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.blockVersion = longToBigint(reader.uint64());
                    continue;
                case 3:
                    if (tag !== 24) {
                        break;
                    }
                    message.p2pVersion = longToBigint(reader.uint64());
                    continue;
                case 4:
                    if (tag !== 34) {
                        break;
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.initialHeight !== 0n) {
            if (BigInt.asIntN(64, message.initialHeight) !== message.initialHeight) {
                throw new gt.Error("value provided for field message.initialHeight of type int64 too large");
            }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    message.initialHeight = longToBigint(reader.int64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
...
exports.RequestPrepareProposal = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.maxTxBytes !== 0n) {
            if (BigInt.asIntN(64, message.maxTxBytes) !== message.maxTxBytes) {
                throw new gt.Error("value provided for field message.maxTxBytes of type int64 too large");
            }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.maxTxBytes = longToBigint(reader.int64());
                    continue;
                case 2:
                    if (tag !== 18) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            txs: gt.Array.isArray(object?.txs) ? object.txs.map((e) => bytesFromBase64(e)) : [],
    ...
    fromJSON(object) {
        return {
            ...
            decidedLastCommit: isSet(object.decidedLastCommit)
                ? exports.CommitInfo.fromJSON(object.decidedLastCommit)
                : undefined,
            misbehavior: gt.Array.isArray(object?.misbehavior)
                ? object.misbehavior.map((e) => exports.Misbehavior.fromJSON(e))
                : [],
    ...
    fromJSON(object) {
        return {
            ...
            verifyVoteExtension: isSet(object.verifyVoteExtension)
                ...
                : undefined,
            finalizeBlock: isSet(object.finalizeBlock)
                ? exports.ResponseFinalizeBlock.fromJSON(object.finalizeBlock)
                : undefined,
        };
    },
    toJSON(message) {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.appVersion !== 0n) {
            if (BigInt.asUintN(64, message.appVersion) !== message.appVersion) {
                throw new gt.Error("value provided for field message.appVersion of type uint64 too large");
            }
        ...
        if (message.lastBlockHeight !== 0n) {
            if (BigInt.asIntN(64, message.lastBlockHeight) !== message.lastBlockHeight) {
                throw new gt.Error("value provided for field message.lastBlockHeight of type int64 too large");
            }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.appVersion = longToBigint(reader.uint64());
                    continue;
                case 4:
                    if (tag !== 32) {
                        break;
                    }
                    message.lastBlockHeight = longToBigint(reader.int64());
                    continue;
                case 5:
                    if (tag !== 42) {
                        break;
...
exports.ResponseCheckTx = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    message.gasWanted = longToBigint(reader.int64());
                    continue;
                case 6:
                    if (tag !== 48) {
                        break;
                    }
                    message.gasUsed = longToBigint(reader.int64());
                    continue;
                case 7:
                    if (tag !== 58) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            events: gt.Array.isArray(object?.events) ? object.events.map((e) => exports.Event.fromJSON(e)) : [],
            codespace: isSet(object.codespace) ? gt.String(object.codespace) : "",
        };
    },
    toJSON(message) {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.retainHeight !== 0n) {
            if (BigInt.asIntN(64, message.retainHeight) !== message.retainHeight) {
                throw new gt.Error("value provided for field message.retainHeight of type int64 too large");
            }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 3:
                    ...
                    message.retainHeight = longToBigint(reader.int64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            refetchChunks: gt.Array.isArray(object?.refetchChunks)
                ? object.refetchChunks.map((e) => gt.Number(e))
                : [],
            rejectSenders: gt.Array.isArray(object?.rejectSenders)
                ? object.rejectSenders.map((e) => gt.String(e))
                : [],
        };
    },
    toJSON(message) {
...
exports.CommitInfo = {
    ...
    fromJSON(object) {
        return {
            ...
            votes: gt.Array.isArray(object?.votes) ? object.votes.map((e) => exports.VoteInfo.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
