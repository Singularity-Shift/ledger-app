...
exports.QueryConnectionChannelsRequest = {
    ...
    fromJSON(object) {
        return {
            connection: isSet(object.connection) ? gt.String(object.connection) : "",
...
exports.QueryPacketReceiptResponse = {
    ...
    fromJSON(object) {
        return {
            received: isSet(object.received) ? gt.Boolean(object.received) : false,
            proof: isSet(object.proof) ? bytesFromBase64(object.proof) : new Uint8Array(0),
            proofHeight: isSet(object.proofHeight) ? client_1.Height.fromJSON(object.proofHeight) : undefined,
        };
    },
...
exports.QueryPacketAcknowledgementsRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.packetCommitmentSequences) {
            if (BigInt.asUintN(64, v) !== v) {
                throw new gt.Error("a value provided in array field packetCommitmentSequences of type uint64 is too large");
            }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    if (tag === 32) {
                        message.packetCommitmentSequences.push(longToBigint(reader.uint64()));
                        continue;
                    }
                    if (tag === 34) {
    ...
    fromJSON(object) {
        return {
            ...
            channelId: isSet(object.channelId) ? gt.String(object.channelId) : "",
            pagination: isSet(object.pagination) ? pagination_1.PageRequest.fromJSON(object.pagination) : undefined,
            packetCommitmentSequences: gt.Array.isArray(object?.packetCommitmentSequences)
                ? object.packetCommitmentSequences.map((e) => BigInt(e))
                : [],
        };
    },
    toJSON(message) {
...
exports.QueryUnreceivedPacketsResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.sequences) {
            if (BigInt.asUintN(64, v) !== v) {
                throw new gt.Error("a value provided in array field sequences of type uint64 is too large");
            }
            writer.uint64(v.toString());
        }
        writer.ldelim();
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    if (tag === 8) {
                        message.sequences.push(longToBigint(reader.uint64()));
                        continue;
                    }
                    if (tag === 10) {
                        const end2 = reader.uint32() + reader.pos;
    ...
    fromJSON(object) {
        return {
            sequences: gt.Array.isArray(object?.sequences) ? object.sequences.map((e) => BigInt(e)) : [],
            height: isSet(object.height) ? client_1.Height.fromJSON(object.height) : undefined,
        };
    },
    toJSON(message) {
...
exports.QueryUnreceivedAcksRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.packetAckSequences) {
            if (BigInt.asUintN(64, v) !== v) {
                throw new gt.Error("a value provided in array field packetAckSequences of type uint64 is too large");
            }
            writer.uint64(v.toString());
        }
        writer.ldelim();
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    if (tag === 24) {
                        message.packetAckSequences.push(longToBigint(reader.uint64()));
                        continue;
                    }
                    if (tag === 26) {
                        const end2 = reader.uint32() + reader.pos;
    ...
    fromJSON(object) {
        return {
            portId: isSet(object.portId) ? gt.String(object.portId) : "",
            channelId: isSet(object.channelId) ? gt.String(object.channelId) : "",
            packetAckSequences: gt.Array.isArray(object?.packetAckSequences)
                ? object.packetAckSequences.map((e) => BigInt(e))
                : [],
        };
    },
    toJSON(message) {
...
exports.QueryNextSequenceReceiveResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.nextSequenceReceive !== 0n) {
            if (BigInt.asUintN(64, message.nextSequenceReceive) !== message.nextSequenceReceive) {
                throw new gt.Error("value provided for field message.nextSequenceReceive of type uint64 too large");
            }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.nextSequenceReceive = longToBigint(reader.uint64());
                    continue;
                case 2:
                    if (tag !== 18) {
                        break;
    ...
    fromJSON(object) {
        return {
            nextSequenceReceive: isSet(object.nextSequenceReceive) ? BigInt(object.nextSequenceReceive) : 0n,
            proof: isSet(object.proof) ? bytesFromBase64(object.proof) : new Uint8Array(0),
            proofHeight: isSet(object.proofHeight) ? client_1.Height.fromJSON(object.proofHeight) : undefined,
        };
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.nextSequenceSend = longToBigint(reader.uint64());
                    continue;
                case 2:
                    if (tag !== 18) {
                        break;
...
exports.QueryChannelParamsResponse = {
    ...
    fromPartial(object) {
        const message = createBaseQueryChannelParamsResponse();
        message.params =
            object.params !== undefined && object.params !== null ? channel_1.Params.fromPartial(object.params) : undefined;
        return message;
    },
};
