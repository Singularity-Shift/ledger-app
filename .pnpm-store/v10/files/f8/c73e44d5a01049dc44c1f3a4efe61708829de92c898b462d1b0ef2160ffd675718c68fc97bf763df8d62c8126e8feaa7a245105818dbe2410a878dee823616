...
exports.StoreCodeAuthorization = {
    ...
    fromJSON(object) {
        return {
            grants: gt.Array.isArray(object?.grants) ? object.grants.map((e) => exports.CodeGrant.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.ContractExecutionAuthorization = {
    ...
    fromJSON(object) {
        return {
            grants: gt.Array.isArray(object?.grants)
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.remaining = longToBigint(reader.uint64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.callsRemaining = longToBigint(reader.uint64());
                    continue;
                case 2:
                    if (tag !== 18) {
                        break;
...
exports.AcceptedMessagesFilter = {
    ...
    fromJSON(object) {
        return {
            messages: gt.Array.isArray(object?.messages) ? object.messages.map((e) => bytesFromBase64(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
