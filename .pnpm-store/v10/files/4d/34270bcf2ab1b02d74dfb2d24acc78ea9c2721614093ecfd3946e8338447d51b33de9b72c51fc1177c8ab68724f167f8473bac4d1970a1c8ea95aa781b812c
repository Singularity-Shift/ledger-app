...
exports.QueryValidatorOutstandingRewardsResponse = {
    ...
    fromJSON(object) {
        return {
            rewards: isSet(object.rewards) ? distribution_1.ValidatorOutstandingRewards.fromJSON(object.rewards) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.startingHeight = longToBigint(reader.uint64());
                    continue;
                case 3:
                    if (tag !== 24) {
                        break;
                    }
                    message.endingHeight = longToBigint(reader.uint64());
                    continue;
                case 4:
                    if (tag !== 34) {
                        break;
...
exports.QueryValidatorSlashesResponse = {
    ...
    fromJSON(object) {
        return {
            slashes: gt.Array.isArray(object?.slashes)
...
exports.QueryDelegationRewardsResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.rewards) {
            distribution_1.DecPool.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            rewards: gt.Array.isArray(object?.rewards) ? object.rewards.map((e) => distribution_1.DecPool.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.QueryDelegationTotalRewardsResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.total) {
            distribution_1.DecPool.encode(v, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
