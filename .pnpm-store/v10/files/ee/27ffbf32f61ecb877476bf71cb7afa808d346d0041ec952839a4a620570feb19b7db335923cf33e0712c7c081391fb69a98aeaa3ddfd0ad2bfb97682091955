    ...
    fromJSON(object) {
        return {
            ...
            counterpartyChannelId: isSet(object.counterpartyChannelId)
                ? gt.String(object.counterpartyChannelId)
                : "",
            counterpartyVersion: isSet(object.counterpartyVersion) ? gt.String(object.counterpartyVersion) : "",
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    message.counterpartyUpgradeSequence = longToBigint(reader.uint64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    message.nextSequenceRecv = longToBigint(reader.uint64());
                    continue;
                case 5:
                    if (tag !== 42) {
                        break;
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.upgradeSequence = longToBigint(reader.uint64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            counterpartyUpgrade: isSet(object.counterpartyUpgrade)
                ? upgrade_1.Upgrade.fromJSON(object.counterpartyUpgrade)
                : undefined,
            proofChannel: isSet(object.proofChannel) ? bytesFromBase64(object.proofChannel) : new Uint8Array(0),
            proofUpgrade: isSet(object.proofUpgrade) ? bytesFromBase64(object.proofUpgrade) : new Uint8Array(0),
            proofHeight: isSet(object.proofHeight) ? client_1.Height.fromJSON(object.proofHeight) : undefined,
    ...
    fromJSON(object) {
        return {
            ...
            counterpartyChannel: isSet(object.counterpartyChannel)
                ? channel_1.Channel.fromJSON(object.counterpartyChannel)
                : undefined,
            proofChannel: isSet(object.proofChannel) ? bytesFromBase64(object.proofChannel) : new Uint8Array(0),
            proofHeight: isSet(object.proofHeight) ? client_1.Height.fromJSON(object.proofHeight) : undefined,
            signer: isSet(object.signer) ? gt.String(object.signer) : "",
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.totalPrunedSequences = longToBigint(reader.uint64());
                    continue;
                case 2:
                    if (tag !== 16) {
                        break;
                    }
                    message.totalRemainingSequences = longToBigint(reader.uint64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            totalRemainingSequences: isSet(object.totalRemainingSequences)
                ? BigInt(object.totalRemainingSequences)
                : 0n,
        };
    },
    toJSON(message) {
