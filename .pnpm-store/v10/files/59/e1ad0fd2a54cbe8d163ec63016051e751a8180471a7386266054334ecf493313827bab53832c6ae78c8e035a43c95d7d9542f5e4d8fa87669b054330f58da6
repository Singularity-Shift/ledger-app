...
exports.TallyResult = {
    ...
    fromJSON(object) {
        return {
            yes: isSet(object.yes) ? gt.String(object.yes) : "",
            abstain: isSet(object.abstain) ? gt.String(object.abstain) : "",
            no: isSet(object.no) ? gt.String(object.no) : "",
            noWithVeto: isSet(object.noWithVeto) ? gt.String(object.noWithVeto) : "",
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.Vote = {
    ...
    fromJSON(object) {
        return {
            ...
            option: isSet(object.option) ? voteOptionFromJSON(object.option) : 0,
            options: gt.Array.isArray(object?.options)
