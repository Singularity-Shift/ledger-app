...
exports.Record_Local = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.privKey !== undefined) {
            obj.privKey = any_1.Any.toJSON(message.privKey);
        }
        return obj;
    },
    create(base) {
        return exports.Record_Local.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseRecord_Local();
        message.privKey =
            object.privKey !== undefined && object.privKey !== null ? any_1.Any.fromPartial(object.privKey) : undefined;
        return message;
    },
};
...
exports.Record_Ledger = {
    ...
    create(base) {
        return exports.Record_Ledger.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseRecord_Ledger();
        message.path =
            object.path !== undefined && object.path !== null ? hd_1.BIP44Params.fromPartial(object.path) : undefined;
        return message;
    },
};
...
exports.Record_Multi = {
    ...
    create(base) {
        return exports.Record_Multi.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseRecord_Multi();
        return message;
...
exports.Record_Offline = {
    ...
    create(base) {
        return exports.Record_Offline.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseRecord_Offline();
        return message;
