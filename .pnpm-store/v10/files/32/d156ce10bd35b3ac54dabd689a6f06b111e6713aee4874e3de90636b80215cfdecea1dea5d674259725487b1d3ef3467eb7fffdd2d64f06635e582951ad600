...
exports.QueryConstitutionRequest = {
    ...
    create(base) {
        return exports.QueryConstitutionRequest.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseQueryConstitutionRequest();
        return message;
...
exports.QueryConstitutionResponse = {
    ...
    fromJSON(object) {
        return { constitution: isSet(object.constitution) ? gt.String(object.constitution) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.constitution !== "") {
    ...
    create(base) {
        return exports.QueryConstitutionResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseQueryConstitutionResponse();
...
exports.QueryParamsRequest = {
    ...
    fromJSON(object) {
        return { paramsType: isSet(object.paramsType) ? gt.String(object.paramsType) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.paramsType !== "") {
...
class QueryClientImpl {
    ...
    Constitution(request, metadata) {
        return this.rpc.unary(exports.QueryConstitutionDesc, exports.QueryConstitutionRequest.fromPartial(request), metadata);
    }
...
exports.QueryConstitutionDesc = {
    ...
    requestType: {
        serializeBinary() {
            return exports.QueryConstitutionRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.QueryConstitutionResponse.decode(data);
            return {
                ...value,
                toObject() {
                    return value;
