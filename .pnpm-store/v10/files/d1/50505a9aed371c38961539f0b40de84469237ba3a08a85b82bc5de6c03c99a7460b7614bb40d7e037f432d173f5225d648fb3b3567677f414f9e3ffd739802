...
exports.FileDescriptorProto = {
    ...
    fromJSON(object) {
        return {
            ...
            dependency: gt.Array.isArray(object?.dependency) ? object.dependency.map((e) => gt.String(e)) : [],
            publicDependency: gt.Array.isArray(object?.publicDependency)
                ? object.publicDependency.map((e) => gt.Number(e))
                : [],
            weakDependency: gt.Array.isArray(object?.weakDependency)
                ? object.weakDependency.map((e) => gt.Number(e))
                : [],
    ...
    fromJSON(object) {
        return {
            ...
            reservedName: gt.Array.isArray(object?.reservedName)
                ? object.reservedName.map((e) => gt.String(e))
                : [],
        };
    },
    toJSON(message) {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.positiveIntValue !== undefined && message.positiveIntValue !== 0n) {
            if (BigInt.asUintN(64, message.positiveIntValue) !== message.positiveIntValue) {
                throw new gt.Error("value provided for field message.positiveIntValue of type uint64 too large");
            }
        ...
        if (message.negativeIntValue !== undefined && message.negativeIntValue !== 0n) {
            if (BigInt.asIntN(64, message.negativeIntValue) !== message.negativeIntValue) {
                throw new gt.Error("value provided for field message.negativeIntValue of type int64 too large");
            }
...
exports.SourceCodeInfo_Location = {
    ...
    fromJSON(object) {
        return {
            ...
            span: gt.Array.isArray(object?.span) ? object.span.map((e) => gt.Number(e)) : [],
            ...
            leadingDetachedComments: gt.Array.isArray(object?.leadingDetachedComments)
                ? object.leadingDetachedComments.map((e) => gt.String(e))
                : [],
        };
    },
    toJSON(message) {
