...
exports.ModuleDescriptor = {
    ...
    fromJSON(object) {
        return {
            goImport: isSet(object.goImport) ? gt.String(object.goImport) : "",
            usePackage: gt.Array.isArray(object?.usePackage)
                ? object.usePackage.map((e) => exports.PackageReference.fromJSON(e))
                : [],
            canMigrateFrom: gt.Array.isArray(object?.canMigrateFrom)
...
exports.PackageReference = {
    ...
    fromJSON(object) {
        return {
            ...
            revision: isSet(object.revision) ? gt.Number(object.revision) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.MigrateFromInfo = {
    ...
    fromJSON(object) {
        return { module: isSet(object.module) ? gt.String(object.module) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.module !== "") {
