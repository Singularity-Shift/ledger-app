        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.queryHeight = longToBigint(reader.uint64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
...
exports.QueryTotalRecvFeesResponse = {
    ...
    fromJSON(object) {
        return {
            recvFees: gt.Array.isArray(object?.recvFees) ? object.recvFees.map((e) => coin_1.Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.QueryTotalAckFeesResponse = {
    ...
    fromJSON(object) {
        return {
            ackFees: gt.Array.isArray(object?.ackFees) ? object.ackFees.map((e) => coin_1.Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.QueryTotalTimeoutFeesResponse = {
    ...
    fromJSON(object) {
        return {
            timeoutFees: gt.Array.isArray(object?.timeoutFees)
                ? object.timeoutFees.map((e) => coin_1.Coin.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
