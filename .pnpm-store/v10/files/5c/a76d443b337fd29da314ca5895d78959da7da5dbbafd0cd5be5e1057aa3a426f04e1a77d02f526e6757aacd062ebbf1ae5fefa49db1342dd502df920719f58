...
function createBaseQueryParamsResponse() {
    return { params: undefined, escrowAddressString: "" };
}
exports.QueryParamsResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            escrowAddressString: isSet(object.escrowAddressString) ? gt.String(object.escrowAddressString) : "",
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.escrowAddressString !== "") {
            obj.escrowAddressString = message.escrowAddressString;
        }
        return obj;
    },
    create(base) {
...
exports.QueryDesc = { serviceName: "sdk.auction.v1.Query" };
