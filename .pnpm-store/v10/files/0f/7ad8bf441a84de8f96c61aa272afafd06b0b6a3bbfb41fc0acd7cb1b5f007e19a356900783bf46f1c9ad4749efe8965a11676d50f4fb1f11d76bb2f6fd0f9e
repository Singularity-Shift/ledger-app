...
exports.ModuleSchemaDescriptor = {
    ...
    fromJSON(object) {
        return {
            schemaFile: gt.Array.isArray(object?.schemaFile)
    ...
    toJSON(message) {
        ...
        if (message.schemaFile?.length) {
            obj.schemaFile = message.schemaFile.map((e) => exports.ModuleSchemaDescriptor_FileEntry.toJSON(e));
        }
        if (message.prefix.length !== 0) {
    ...
    create(base) {
        return exports.ModuleSchemaDescriptor.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseModuleSchemaDescriptor();
...
exports.ModuleSchemaDescriptor_FileEntry = {
    ...
    fromJSON(object) {
        return {
            ...
            protoFileName: isSet(object.protoFileName) ? gt.String(object.protoFileName) : "",
    ...
    create(base) {
        return exports.ModuleSchemaDescriptor_FileEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseModuleSchemaDescriptor_FileEntry();
