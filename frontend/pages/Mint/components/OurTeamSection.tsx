...
export const OurTeamSection: FC<OurTeamSectionProps> = () => {
  ...
  return (
    <section className="our-team-container px-4 text-center max-w-screen-xl mx-auto w-full bg-white bg-opacity-90 backdrop-blur-sm p-4 rounded-lg border-2 border-black shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.2)] hover:-translate-y-1 transition-all duration-300">
...
const TeamMemberCard: FC<{ person: ConfigTeamMember }> = ({ person }) => {
  ...
  return (
    <Card className="px-4 py-4 w-full flex flex-col items-center gap-3 shadow-[0_4px_15px_rgb(0,0,0,0.1)] hover:shadow-[0_12px_24px_rgb(0,0,0,0.15)] hover:-translate-y-1 transition-all duration-300">
